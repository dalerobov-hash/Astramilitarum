...
public static class ModHelperData
{
    ...
    public const string Name = "AstraMilitarum";
    ...
    public const string RepoOwner = "dalerobov-hash"; // TODO add your github username hero, also in the download url in README.md
    public const string RepoName = "AstraMilitarum"; // TODO add your repo name here, also in the download url in README.md
}
